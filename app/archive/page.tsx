                ...
                <div className="card mb-4">
                    <div className="card-header main-header">
                        <div className="sub-header">
                            ...
                            <h4 className="my-0 font-weight-normal">Exploring - Archive</h4>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className={styles.firstLevel}>
                                            ...
                                            <div className={styles.secondLevel}>
                                                {ledgers.map((ledger) => (
                                                    <div key={ledger.id} className={`${styles.folder} ${styles.noBoxOffset}`}>
                                                        <Image width={16} height={16} src="/icons/file_sorted_lock-1.png" alt="file_sorted_lock" />
                                                        <p>{ledger.name}</p>
                                                    </div>
                                                ))}
                                            </div>
